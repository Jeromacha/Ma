                    ...
                    >
                        {!isOpen && (
                            <>
                                ...
                                >
                                    <h2 className="text-3xl md:text-4xl mb-4 relative z-10">Para la mejor mamá del universo</h2>
                                    <p className="text-lg md:text-xl mb-6">Un mensaje especial para el Día de la Madre</p>
