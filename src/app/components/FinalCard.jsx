        ...
        <div className="flex flex-col items-center justify-center">
            ...
            >
                <div className="relative rounded-2xl shadow-lg bg-gradient-to-br from-pink-100 to-purple-100 border-2 border-pink-200 p-6 overflow-hidden">
                    ...
                    >
                        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-pink-600">¡Feliz Día de la Madre!</h2>
                            ...
                            {!isRevealed ? (
                                ...
                                >
                                    <p className="text-purple-800 text-lg mb-8">
                                        ¡Haz clic en el corazón para ver quién es la persona que mas te ama!
                                    </p>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div className="flex justify-center">
                                            <Image src={MaFoto} alt="Ma" width={200} height={200} className="animate-spin-slow" />
                                        </div>

                                        <h3 className="text-3xl md:text-4xl font-bold text-pink-600 mb-2">Con todo mi amor,</h3>

                                        <h3 className="text-4xl md:text-5xl font-bold text-purple-600">Jeronimo</h3>
                                    </motion.div>
                                    ...
                                    >
                                        Te quiero más de lo que las palabras pueden expresar. ¡Gracias por ser mi todo en esta vida, mamá!❤️
                                    </motion.p>
