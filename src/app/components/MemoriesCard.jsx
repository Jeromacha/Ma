...
export default function MemoriesCard() {
    ...
    const memories = [
        "Siempre sabes cómo hacerme sonreír, incluso en mis peores días.",
        "Siempre he sentido tu amor incondocional, durante toda mi vida.",
        "La forma en la que siempre me has apoyado en mis sueños y decisiones.",
        "Como pasamos las noches viendo series y peliculas.",
        "Me enseñaste a ser una buena persona, con increibles valores y cosas buenas.",
    ]
        ...
        <div className="flex flex-col items-center justify-center">
            ...
            >
                <div className="relative rounded-2xl shadow-lg bg-gradient-to-br from-pink-100 to-purple-100 border-2 border-pink-200 p-6">
                    ...
                    >
                        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-pink-600">Dulces Recuerdos</h2>
